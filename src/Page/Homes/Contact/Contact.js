    ...
    return (
        <div className='my-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 '>
                <div className='bg-blue-100 p-10 rounded-lg flex justify-items-center gap-5'>
                    <span className='text-2xl hover:text-orange-500'><FaPhone></FaPhone></span>
                    <p><span className='font-bold' >Phone: </span> 01989321756</p>
                </div>
                <div className='bg-purple-100 p-10 rounded-lg flex justify-items-center gap-5'>
                    <span className='text-2xl hover:text-orange-500'><FaRegEnvelope></FaRegEnvelope></span>
                    <p className='flex justify-start align-middle gap-3'><span className='font-bold'>Email</span> mdsabbirhowlader60@gmail.com</p>
                </div>
                <div className='bg-green-100 p-10 rounded-lg flex justify-items-center gap-5'>
