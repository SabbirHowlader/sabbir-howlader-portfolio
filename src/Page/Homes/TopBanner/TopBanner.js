...
const TopBanner = () => {
    return (
        <div className="hero min-h-screen mb-10" style={{ backgroundImage: `url("https://www.codewizardshq.com/wp-content/uploads/2021/12/M22-Interactive-web-with-javascript-banner.jpg")` }}>
